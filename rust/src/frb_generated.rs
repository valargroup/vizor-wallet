...
fn wire__crate__api__sync__download_file_over_tor_with_sha1_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "download_file_over_tor_with_sha1",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_expected_sha1_hex = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| async move {
                transform_result_sse::<_, String>(
                    (move || async move {
                        let output_ok = crate::api::sync::download_file_over_tor_with_sha1(
                            api_url,
                            api_dest_path,
                            api_expected_sha1_hex,
                        )
                        .await?;
                        Ok(output_ok)
                    })()
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__sync__download_file_over_tor_with_sha1_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
