...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1895540485;
...
14 => wire__crate__api__voting__confirm_delegation_submission_impl(port, ptr, rust_vec_len, data_len),
15 => wire__crate__api__voting__confirm_vote_submission_impl(port, ptr, rust_vec_len, data_len),
16 => wire__crate__api__sync__create_pczt_from_proposal_impl(port, ptr, rust_vec_len, data_len),
17 => wire__crate__api__sync__create_reserved_pczt_batch_impl(port, ptr, rust_vec_len, data_len),
...
25 => wire__crate__api__keystone__decode_zcash_sign_result_cbor_impl(port, ptr, rust_vec_len, data_len),
26 => wire__crate__api__sync__decrypt_and_store_transaction_impl(port, ptr, rust_vec_len, data_len),
27 => wire__crate__api__secret__decrypt_secret_payload_impl(port, ptr, rust_vec_len, data_len),
28 => wire__crate__api__voting__delegation_submission_wire_json_impl(port, ptr, rust_vec_len, data_len),
29 => wire__crate__api__wallet__delete_account_impl(port, ptr, rust_vec_len, data_len),
30 => wire__crate__api__voting__delete_skipped_bundles_impl(port, ptr, rust_vec_len, data_len),
31 => wire__crate__api__voting__delete_voting_account_state_impl(port, ptr, rust_vec_len, data_len),
...
36 => wire__crate__api__keystone__encode_zcash_sign_batch_ur_parts_impl(port, ptr, rust_vec_len, data_len),
...
56 => wire__crate__api__sync__get_orchard_migration_status_impl(port, ptr, rust_vec_len, data_len),
57 => wire__crate__api__voting__get_round_plan_impl(port, ptr, rust_vec_len, data_len),
58 => wire__crate__api__voting__get_round_recovery_state_impl(port, ptr, rust_vec_len, data_len),
59 => wire__crate__api__sync__get_shield_transparent_status_impl(port, ptr, rust_vec_len, data_len),
61 => wire__crate__api__sync__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
62 => wire__crate__api__sync__get_transaction_data_requests_impl(port, ptr, rust_vec_len, data_len),
64 => wire__crate__api__sync__get_transaction_history_impl(port, ptr, rust_vec_len, data_len),
65 => wire__crate__api__wallet__get_transparent_address_impl(port, ptr, rust_vec_len, data_len),
...
80 => wire__crate__api__sync__migrate_orchard_to_ironwood_impl(port, ptr, rust_vec_len, data_len),
81 => wire__crate__api__sync__migrate_orchard_to_ironwood_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
...
85 => wire__crate__api__keystone__pczt_spend_nullifiers_impl(port, ptr, rust_vec_len, data_len),
86 => wire__crate__api__voting__plan_share_submissions_impl(port, ptr, rust_vec_len, data_len),
87 => wire__crate__api__voting__precompute_delegation_pir_impl(port, ptr, rust_vec_len, data_len),
88 => wire__crate__api__sync__prepare_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
89 => wire__crate__api__sync__prepare_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
90 => wire__crate__api__sync__propose_send_impl(port, ptr, rust_vec_len, data_len),
91 => wire__crate__api__sync__put_subtree_roots_impl(port, ptr, rust_vec_len, data_len),
92 => wire__crate__api__voting__record_share_delegation_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
94 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
95 => wire__crate__api__sync__redact_pczt_for_signer_impl(port, ptr, rust_vec_len, data_len),
97 => wire__crate__api__voting__reset_vote_tree_impl(port, ptr, rust_vec_len, data_len),
98 => wire__crate__api__voting__reset_voting_session_state_impl(port, ptr, rust_vec_len, data_len),
99 => wire__crate__api__voting__resolve_static_voting_config_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__voting__resolve_voting_config_impl(port, ptr, rust_vec_len, data_len),
101 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__voting__set_ballot_intent_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__sync__shield_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
110 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
111 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
112 => wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len),
114 => wire__crate__api__voting__store_keystone_signature_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__voting__sync_vote_tree_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__voting__trusted_voting_round_params_from_config_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
121 => wire__crate__api__voting__vote_commitment_wire_json_impl(port, ptr, rust_vec_len, data_len),
122 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        60 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        63 => wire__crate__api__sync__get_transaction_detail_impl(ptr, rust_vec_len, data_len),
        ...
        96 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        105 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        113 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        120 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        123 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
