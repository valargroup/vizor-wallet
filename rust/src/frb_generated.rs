...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 76282210;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        57 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
        58 => {
            wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len)
        }
        59 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
        61 => {
            wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len)
        }
        62 => wire__crate__api__sync__shield_transparent_balance_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        63 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        64 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
        65 => {
            wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len)
        }
        67 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
        68 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
        69 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
        72 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        56 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        60 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        66 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        70 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        71 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
