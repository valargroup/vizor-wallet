...
void main() {
  ...
  group('preset lookup', () {
    ...
    test('uses the public testnet endpoint as the testnet default', () {
      final endpoint = defaultRpcEndpointConfig('test');

      expect(endpoint.networkName, 'test');
      expect(endpoint.effectivePresetId, 'default-testnet');
      expect(
