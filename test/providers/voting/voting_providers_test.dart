...
void main() {
  ...
  test(
    'rounds provider skips planner state when proposal ids are unavailable',
    () async {
      final http = FakeVotingHttpClient(
        responses: {
          'https://voting.example/static-voting-config.json':
      ...
      expect(rounds.single.voted, isFalse);
      expect(rounds.single.inProgress, isFalse);
      expect(recoveryApi.roundPlanProposalIds, isEmpty);
    },
  );
