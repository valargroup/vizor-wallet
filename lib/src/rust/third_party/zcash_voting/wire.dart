...
class DelegationBundlePlanView {
  final int bundleCount;
  final Uint32List pendingBundleIndexes;
  final Uint32List submittedBundleIndexes;

  const DelegationBundlePlanView({
    required this.bundleCount,
    required this.pendingBundleIndexes,
    required this.submittedBundleIndexes,
  });

  @override
  int get hashCode =>
      bundleCount.hashCode ^
      pendingBundleIndexes.hashCode ^
      submittedBundleIndexes.hashCode;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is DelegationBundlePlanView &&
          runtimeType == other.runtimeType &&
          bundleCount == other.bundleCount &&
          pendingBundleIndexes == other.pendingBundleIndexes &&
          submittedBundleIndexes == other.submittedBundleIndexes;
}
