...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1230462054;
...
abstract class RustLibApi extends BaseApi {
  ...
  BigInt crateApiVotingBeginShareTracking();
  ...
  void crateApiVotingCancelShareTracking({required BigInt operationId});
  ...
  Future<List<String>> crateApiVotingSubmitShareToHelpers({
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  BigInt crateApiVotingBeginShareTracking() {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateApiVotingBeginShareTrackingConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiVotingBeginShareTrackingConstMeta =>
      const TaskConstMeta(debugName: "begin_share_tracking", argNames: []);
  ...
  void crateApiVotingCancelShareTracking({required BigInt operationId}) {
    return handler.executeSync(
      SyncTask(
        callFfi: () {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_u_64(operationId, serializer);
        ...
        constMeta: kCrateApiVotingCancelShareTrackingConstMeta,
  ...
  TaskConstMeta get kCrateApiVotingCancelShareTrackingConstMeta =>
      const TaskConstMeta(
        debugName: "cancel_share_tracking",
  ...
  Future<List<String>> crateApiVotingSubmitShareToHelpers({
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          final serializer = SseSerializer(generalizedFrbRustBinding);
          sse_encode_String(shareWireJson, serializer);
          sse_encode_list_String(candidateServers, serializer);
        ...
        constMeta: kCrateApiVotingSubmitShareToHelpersConstMeta,
        argValues: [shareWireJson, candidateServers, targetCount, nowSeconds],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiVotingSubmitShareToHelpersConstMeta =>
      const TaskConstMeta(
        debugName: "submit_share_to_helpers",
        argNames: [
          "shareWireJson",
          "candidateServers",
          "targetCount",
  ...
  ApiShareTrackingReport dco_decode_api_share_tracking_report(dynamic raw) {
    ...
    return ApiShareTrackingReport(
      ...
      unrecoverable: dco_decode_list_api_share_key(arr[2]),
      cancelled: dco_decode_bool(arr[3]),
      nextDelaySeconds: dco_decode_opt_box_autoadd_u_64(arr[4]),
    );
  }
